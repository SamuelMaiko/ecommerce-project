...
const SuppliersDetailPage = () => {
    ...
    const getSpecificSupplier = async () => {
      try {
        const response = await instance.get(
          `/api/accounts/suppliers/${supplier_id}/`
        );
  ...
  return (
    <div className="w-full">
      <div className="w-full md:bg-blue-500">
        ...
        <div>
          <div className="flex justify-between mb-4">
            <div
              ...
              className={`${
                activeSection === 0 ? " border-b-4 border-blue-500" : ""
              } hover:bg-[rgba(0,0,255,0.1)] transition-colors duration-300 py-2 flex justify-center w-full text-gray-600 font-semibold cursor-pointer`}
            >
              <p>Raw Materials</p>
            </div>
            <div
              ...
              className={`${
                activeSection === 1 ? " border-b-4 border-blue-500" : ""
              } hover:bg-[rgba(0,0,255,0.1)] transition-colors duration-300 py-2 flex justify-center w-full text-gray-600 font-semibold cursor-pointer`}
            >
          ...
          <div>
            <div className={`${activeSection === 0 ? "" : "hidden"}`}>
              {supplierProducts ? (
                ...
                <div className="h-[20rem] grid place-items-center text-lg text-center md:text-xl font-medium text-gray-600 ">
            ...
            <div
              ...
              } h-[20rem] grid place-items-center`}
            >
              <h1 className="text-lg text-center md:text-xl font-medium text-gray-600">
