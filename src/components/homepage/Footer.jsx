...
const Footer = () => {
  return (
    <div className='w-full h-full bg-[#AED9E0] text-[#333333] pb-[2rem] '>
        {/* _____________upper footer container _______ */}
        <div className='w-[90%] mx-auto grid footer-container gap-[10px]'>
            <div className='py-20 flex flex-col items-center'>
                <div>

                    <h3 className='font-heading font-semibold text-xl'>About Us</h3>
                    <p className='font-body'>We are a leading provider of raw materials extraction solutions, committed to sustainability and innovation.</p>
                </div>
            </div>
            {/* _____________ divider ________ */}
            <div className='pt-16 pb-8'>
                <div className="w-[1px] h-full bg-[#333333] "></div>
            </div>
            <div className='py-20 flex flex-col items-center'>
            <div>

            <h3 className='font-heading font-semibold text-xl'>Quick Links</h3>
                <ul className='font-body '>
                <li><a className="hover:text-[#555555] hover:underline" href="#">Home</a></li>
                <li><a className="hover:text-[#555555] hover:underline" href="#">Products</a></li>
                <li><a className="hover:text-[#555555] hover:underline" href="#">About</a></li>
                <li><a className="hover:text-[#555555] hover:underline" href="#">Contact</a></li>
                <li><a className="hover:text-[#555555] hover:underline" href="#">Blog</a></li>
                </ul>
            ...
            <div className='py-20 flex flex-col items-center'>
                <div>
                    ...
                    <h3 className='font-heading font-semibold text-xl '>Follow Us</h3>
                    {/* <ul className='font-body font-medium'> */}
                    ...
                    <div className="parent">
                        ...
                        <button className="button2 btn-1">
                        ...
                        <button className="button2 btn-2">
                        ...
                        <button className="button2 btn-3">
                        ...
                        <button className="button2 btn-4">
        ...
        <div className='grid place-items-center mb-[2rem]'>
            <h1 className='text-xl font-semibold text-center font-heading '>Partners</h1>
            <p className='text-[5.5rem]'>
                <SiCocacola/>
            </p>
            {/* <p>
                <img className='h-[2rem] w-[4rem]' src={safaricom} alt="" />
            </p> */}

        </div>

        <div className='text-[#555555] flex justify-center text-sm font-body'>
            <div>
                <p>Greener Earth</p>
                <p>Copyright &copy; 2024 Greener Earth, Inc.</p>
            </div>
        </div>
